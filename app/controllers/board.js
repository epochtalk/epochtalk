module.exports = ['$scope', '$state', '$stateParams', '$window', 'Auth', 'Threads', 'board', 'threads', 'page', 'threadLimit',
  function($scope, $state, $stateParams, $window, Auth, Threads, board, threads, page, threadLimit, postLimit) {
    var ctrl = this;
    ...
    $state.go('test.sub.pagination', { limit: $stateParams.limit, page: $stateParams.page });
