module.exports = ['$rootScope', '$scope', '$location', '$timeout', '$anchorScroll', 'Session', 'AdminReports', 'AdminUsers', 'Posts', 'postReports', 'reportCount', 'page', 'limit', 'field', 'desc', 'filter', 'reportId', function($rootScope, $scope, $location, $timeout, $anchorScroll, Session, AdminReports, AdminUsers, Posts, postReports, reportCount, page, limit, field, desc, filter, reportId) {
  var ctrl = this;
