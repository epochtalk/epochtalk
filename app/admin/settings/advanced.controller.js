var ctrl = ['$scope', '$timeout', 'settings', 'blacklist', 'AdminSettings', 'Alert', function($scope, $timeout, settings, blacklist, AdminSettings, Alert) {
  var ctrl = this;
  ...
  this.deleteRule = function(rule) {
    ...
    AdminSettings.deleteFromBlacklist({ id: rule.id }).$promise
    .then(function(updatedBlacklist) {
      ctrl.blacklist = updatedBlacklist;
