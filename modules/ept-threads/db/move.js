...
module.exports = function(threadId, newBoardId) {
  ...
  return using(db.createTransaction(), function(client) {
    ...
    // Update last post info of new board with old last post info of old board
    .then(function() {
      // Check that the last thread is being moved and if the new boards last post date is older
      if (oldBoard.last_thread_id === threadId && newBoard.last_post_created_at < oldBoard.last_post_created_at) {
        params = [oldBoard.last_post_username, oldBoard.last_post_created_at, oldBoard.last_thread_id, oldBoard.last_thread_title, oldBoard.last_post_position, newBoardId];
    ...
    // Update last post info of old board if last thread was moved
    .then(function() {
